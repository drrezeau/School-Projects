...
*    David Lambertson
* Summary:
*    This program is a mail client, allowing someone to send emails to
*    a person who has an account on the linux lab. It has a simple GUI
*    and uses SMTP to connect to the mail server and send an email to the
*    given email address.
************************************************************************** */
...
class SMTPConnection
{
   ...
   {
      //Makes the connection to the jordan.byui.edu mail server
      connection = new Socket(envelope.DestAddr, SMTP_PORT);
      //creates the feed for receiving and sending 
