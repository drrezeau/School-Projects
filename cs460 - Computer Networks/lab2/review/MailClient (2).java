...
*    Nghia Vuong
* Summary:
*    This program is an MailClient program providing Mail Agent to allow
...
class SMTPConnection
{
   ...
   public SMTPConnection(Envelope envelope) throws IOException
   {
      ...
      if (parseReply(reply) != 220) {
         throw new IOException("Reply 220 NOT MATCH");
      }
   ...
   private void sendCommand(String command, int rc) throws IOException
   {
      ...
      if (parseReply(reply) != rc) {
         throw new IOException("REPLY CODE NOT MATCH");
      }
   }
   ...
   private int parseReply(String reply)
   {
      ...
      return (new Integer(parser.nextToken())).intValue();
   }
