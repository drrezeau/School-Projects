 ...
 * @author david_000
 */
public class EditGearController implements Initializable {
    ...
    public void setText(Gear gear) {
        name.setText(gear.getName());
        rating.setText(Integer.toString(gear.getRating()));
        notes.setText(gear.getNotes());
        
        new ShadowRunApp().getCharacter().deleteGear(gear.getName());
    }
