...
##############################################################
#Summary of Changes: The thing I changed was when I was using iostat
#on the third to last question, I added the -k to get better information.
#By doing so, I didn't have to divide the number by two to get the 
#right number. It would have been nice to be able to use '\t' but since
#the spacing was 4 spaces, I couldn't use '\t'
##############################################################
